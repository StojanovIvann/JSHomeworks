...
let colorButton = document.getElementById ("btnForTheme");
...
function PrintExcercises(inputObject, numOfProps) {
    ...
    if (isNaN(numOfExcercises.value)){
        alert("please enter a number!!");
    }

    else if (numOfExcercises.value < 0){
        alert('error, you entered a negative number');
    }
    
    else if (numOfExcercises.value > Object.values(inputObject).length){
...
function changeTheme (button){
  ...
  if ((view.style.backgroundColor === 'white') && ( view.style.color ==='black') ){
    view.style.backgroundColor = 'black';
    view.style.color = 'white';
  }
  
  else if ((view.style.backgroundColor !== 'white') && ( view.style.color !=='black') ){
